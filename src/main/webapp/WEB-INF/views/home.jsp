...
<div class="grid" id="languageGrid">
    ...
    <div class="card programming" onclick="openIDE('cpp')">
    ...
    <div class="card web" onclick="openIDE('css')">
        <i class="devicon-css3-plain colored"></i>
        <span>CSS</span>
    </div>

    <div class="card web" onclick="openIDE('javascript')">
...
<script>
    ...
    function openIDE(lang) {
        window.location.href = "${pageContext.request.contextPath}/ide?lang=" + lang;
    }
</script>
