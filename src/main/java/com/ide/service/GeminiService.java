...
public class GeminiService {
    ...
    private String callGemini(String prompt) {
        ...
        String apiUrl = "https://generativelanguage.googleapis.com/v1beta/models/gemini-3.1-flash-lite-preview:generateContent?key=" + apiKey;
    ...
    public String customPrompt(String code, String prompt) {
        String fullPrompt = prompt;
        if (code != null && !code.trim().isEmpty()) {
            fullPrompt = "Here is the current code:\n" + code + "\n\nUser Prompt:\n" + prompt;
        }
